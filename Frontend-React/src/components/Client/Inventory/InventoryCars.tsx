...
const InventoryCars: React.FC<InventoryCarsProps> = ({ title = 'Featured Cars', filters }) => {
    ...
    useEffect(() => {
        const fetchCars = async () => {
            setLoading(true);
            try {
                const response = await apiClient.get('/car-inventory', { params: { ...filters, page: currentPage } });
    ...
    return (
        <section id="InventoryCars" className="py-8 bg-gray-50">
